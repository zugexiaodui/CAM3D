...
class _NonLocalBlockND(nn.Module):
    def __init__(self, in_channels, inter_channels=None, dimension=3, sub_sample=True, bn_layer=True):
        ...
        print("inter_channels=",self.inter_channels,'sub_sample=',sub_sample)
        if dimension == 3:
            conv_nd = nn.Conv3d
...
class NONLocalBlock3D(_NonLocalBlockND):
    def __init__(self, in_channels, inter_channels=None, sub_sample=True, bn_layer=True): # TODO:sub_sample
