...
from ops.CAM3D_module import ClassAttentionMapping
import cv2
...
def cam_process(val_loader, model,norm_param):
    ...
    for input,target in val_loader:
        ...
        for i,(src_img,dst_img) in enumerate(zip(*cam_out)):
            cv2.imwrite(f"frame{i+1}_src.jpg",src_img)
            cv2.imwrite(f"frame{i+1}_dst.jpg",dst_img)
        break
